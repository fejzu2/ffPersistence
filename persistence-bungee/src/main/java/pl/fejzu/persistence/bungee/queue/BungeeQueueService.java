package pl.fejzu.persistence.bungee.queue;
...
public final class BungeeQueueService {
    ...
    public BungeeQueueService(BungeePluginMessagingBridge messagingBridge, ProxySettings settings) {
    ...
    public BungeeQueueService(BungeePluginMessagingBridge messagingBridge) {
        this(messagingBridge, ProxySettings.defaults());
    }
